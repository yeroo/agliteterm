...
PowerShell, not an installed tool or user theme. OmpTheme is cleared before any restart.
...
opt-in and B>R>K precedence; opt-out/readonly/closed/adopted exclusions; capture policy readback;
