...
$cases=@(
    ...
    @{command='begin {"strict-begin"}';profile='Set-StrictMode -Version 2.0';code=0;text='strict-begin';exact='strict-begin'},
    @{command='process {"strict-process"}';profile='Set-StrictMode -Version Latest';code=0;text='strict-process';exact='strict-process'},
    @{command='end {"strict-end"}';profile='Set-StrictMode -Version Latest';code=0;text='strict-end';exact='strict-end'},
    @{command='param()';profile='Set-StrictMode -Version Latest';code=0;text=''},
    @{command='';profile='Set-StrictMode -Version Latest';code=0;text=''},
    @{command='using namespace System.Text';profile='Set-StrictMode -Version Latest';code=0;text=''},
    @{command='param($x=$(cmd.exe /d /c exit 7))';profile='Set-StrictMode -Version Latest';code=7;text=''},
    @{command='clean {"discarded"}';profile='Set-StrictMode -Version Latest';code=0;text='';ps7=$true},
