...
$all=@('ui-ownership.unit','ui-concurrency','control-transport.unit','focus-status.unit','control-honesty-clipboard.unit','readline-status.unit','overlay-command.unit')+$all
