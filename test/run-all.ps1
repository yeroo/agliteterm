...
$all=@('omp-idle','ui-ownership.unit','ui-concurrency','creation-protocol.unit','creation-host','control-transport.unit','focus-status.unit','control-honesty-clipboard.unit','readline-status.unit','overlay-command.unit')+$all
